...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center" style="margin-top:20px;">
            <div class="col-lg-6">
                <div class="row">
                    <div class="col-lg-offset-4 col-lg-4">
                        ...
                        @else
                            <img src="{{asset('img/img/content/season_default.jpg')}}" style="width:100%">
                        @endif
                    </div>
                </div>
                <div class="form-group">
                    <label for="mainImage" style = "font-size: 18px" class="col-form-label text-md-right color">Naslovna slika:</label><br>
                    <form enctype="multipart/form-data" method="post" id="changePictureForm" action="/season/{{$season->content_id}}/edit/changeAvatar" class = "contact-form fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
                ...
                <div class="form-group">
                    <form enctype="multipart/form-data" method="post" action="/season/{{$season->content_id}}/edit/addPictures" class = "contact-form fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
            ...
            <div class="col-lg-6">
                <form enctype="multipart/form-data" method="post" action="/season/{{$season->content_id}}/edit/changeData" class = "contact-form fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    @csrf
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="numOfEpisodes" name="duration" class="form-control">
                    </div>
        ...
        <div class="row justify-content-center" style="margin-top:20px;">
            <div class="col-lg-12">
                <div class="form-group">
                    ...
                    <form method="post" enctype="multipart/form-data" action="/season/{{$season->content_id}}/edit/deletePictures" class = "contact-form fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
                        <div class="row">
                            <?php $i=0; ?>
